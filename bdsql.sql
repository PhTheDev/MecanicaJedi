...
CREATE TABLE Usuario (
    ...
    tipoUsuario VARCHAR(20) NOT NULL CHECK (tipoUsuario IN ('Administrador', 'Funcionario')), 
    dataCriacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP, -- Data de criação do registro
...
CREATE TABLE Veiculo (
    ...
    idAcessorio INT NULL REFERENCES Acessorios(idAcessorio)
);
...
CREATE TABLE OrdemDeServico (
    ...
    status VARCHAR(20) NOT NULL CHECK(status IN('Orçamento','Aprovado', 'Finalizado', 'Em Andamento', 'Pago')),
    data DATE NOT NULL,
...
CREATE TABLE itemServico (
    ...
    idServico INT NOT NULL REFERENCES Servicos(idServico),
    idOS INT NOT NULL REFERENCES OrdemDeServico(idOS),
